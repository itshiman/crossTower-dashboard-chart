...
class DepositChartMonthly extends Component {
  state = {
    data: false,
    options: {
      chart: {
      ...
      title: {
        text: 'Deposit Withdraw Data for a month',
      },
      xaxis: {
        type: 'datetime',
        categories: [],
    ...
    return (
      <div>
        {this.state.data ? (
          ...
          <h3>Loading Deposit Withdraw Chart for a Month...</h3>
        )}
      </div>
    );
  }
...
export default DepositChartMonthly;
